...
## M0 toolchain — A6/C8 audit tooling and the image pin (DCX-108)
...
`workflow`-scoped GitHub credential, which no agent currently holds; that is the
only reason this work has stalled (see DCX-108/DCX-137).
