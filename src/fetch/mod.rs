...
pub mod about;
/// Generated by `tools/gen-attestations.py` -- see that file's own doc
/// comment. Hand-verification tests live in the sibling
/// `attestations_tests` module (NOT inside this generated file, which gets
/// silently overwritten on every regeneration).
pub mod attestations_data;
#[cfg(test)]
